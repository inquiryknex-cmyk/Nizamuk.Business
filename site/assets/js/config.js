...
window.NIZAMOK = {
  ...
  // صفحات بيع «لمحات» لكل نمط، على غرار rebuildPages تمامًا. كل زرّ شراءٍ
  // للمحة في الموقع يمرّ بها أولًا بدل القفز إلى Dodo: الصفحة تحمل المرآة
  // والاقتباسات والسلّم ومخرج الاختبار لمن لم تحسم نمطها بعد. صفحة الدفع
  // لا تحمل شيئًا من ذلك.
  // نفس مطابقة المفاتيح: asira -> asirat، mutafadiya -> mutafadia.
  lamhatPages: {
    mubdia:     '/lamhat/mubdia/',
    asira:      '/lamhat/asirat/',
    mutafadiya: '/lamhat/mutafadia/',
    kafua:      '/lamhat/kafua/'
  },
