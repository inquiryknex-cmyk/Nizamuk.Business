...
window.NIZAMOK_I18N_EN = {
  ...
  t: {
    ...
    cardLamhat: { label: 'Step one, available now', title: 'Your Lamhat', desc: 'A focused reading of what is happening in your day right now: where you stall, and which behavior deceives you.', cta: 'Open Your Lamhat' },
    cardJuthur: { label: 'Step two, the deeper reading', title: 'Your Pattern Roots', desc: 'A book on the origin of the pattern: why it began, which feeling it protects, and why it returns.', cta: 'Read the Roots' },
    cardRebuild: { label: 'Step three, the practical shift', title: 'The Rebuild System', desc: 'A complete practical system that turns understanding into motion: stages, tools, and steps that fit your pattern.', cta: 'Begin the Rebuild' },
