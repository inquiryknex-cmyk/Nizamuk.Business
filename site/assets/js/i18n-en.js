...
window.NIZAMOK_I18N_EN = {
  ...
  t: {
    ...
    markSecond: 'Also close to me',
    promptClosest: 'Choose the closest to you — what repeats in your life',
    promptSecond: "Is there a second answer that's also like you? It's optional",
