...
(function () {
  ...
  /* Recording-take replication: display order fixed to the uploaded session */
  const FIXED_ORDER = [[0, 2, 1, 3], [2, 1, 0, 3], [3, 1, 0, 2], [1, 2, 0, 3], [2, 3, 1, 0], [2, 1, 3, 0], [1, 0, 3, 2], [3, 2, 1, 0], [1, 2, 0, 3], [1, 3, 2, 0], [2, 1, 0, 3], [3, 2, 0, 1]];
  questions.forEach((q, qi) => { q.order = FIXED_ORDER[qi]; });
